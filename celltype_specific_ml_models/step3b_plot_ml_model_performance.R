...
####################
# read in the data
df = feather::read_feather('rdas/SingleTask_IDR_peakPrediction_CNN_performance.feather')
...
pdf('plots/mouse_ml_model-CNN_performance.pdf', width = 11, height = 5)
...
pdf('figures/figure_mouse_ml_model-CNN_performance.pdf', 
