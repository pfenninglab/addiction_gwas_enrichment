...
df.reset_index().to_feather('rdas/SingleTask_IDR_peakPrediction_CNN_v3_performance.feather')
df.reset_index().to_csv('tables/SingleTask_IDR_peakPrediction_CNN_v3_performance.tsv', sep = '\t')
