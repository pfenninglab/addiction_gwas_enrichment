...
mkdir -p $DIR/candidate_plots_20210414; cd $DIR/candidate_plots_20210414

###############################
# SNP blocks to plot 
BLOCK3=$DIR/BED/snp_candidate_snpBlock.bed
TRACKS3=$DIR/config/candidate_snps_track_gtf_NeuN+_mmOrth_20210414.ini

# tall track for figure
pyGenomeTracks --tracks $TRACKS3 --BED $BLOCK3 --fontSize 6 --width 14 --dpi 1000 --trackLabelFraction 0.15 --outFileName addiction_snp_candidate_20210414.pdf

# wide track for ppt
pyGenomeTracks --tracks $TRACKS3 --BED $BLOCK3 --fontSize 9 --width 23 --dpi 1000 --trackLabelFraction 0.15 --outFileName addiction_snp_candidate_wide_20210414.pdf


# # SNP blocks to plot
# BLOCK1=$DIR/BED/ctx_candidate_snpBlock.bed
# TRACKS1=$DIR/config/candidate_snps_track_gtf_NeuN+_mmOrth_Ctx_20210414.ini
...
# TRACKS2=$DIR/config/candidate_snps_track_gtf_NeuN+_mmOrth_Str_20210414.ini
